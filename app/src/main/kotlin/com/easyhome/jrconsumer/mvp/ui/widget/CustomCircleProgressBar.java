...
import com.easyhome.jrconsumer.app.utils.CommonUtils;
...
public class CustomCircleProgressBar extends View {
    ...
    public CustomCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        outsideRadius = a.getDimension(R.styleable.CustomCircleProgressBar_outside_radius, CommonUtils.dp2px(getContext(), 60.0f));
        ...
        progressTextColor = a.getColor(R.styleable.CustomCircleProgressBar_progress_text_color, ContextCompat.getColor(getContext(), R.color.color222));
        progressTextSize = a.getDimension(R.styleable.CustomCircleProgressBar_progress_text_size, CommonUtils.dp2px(getContext(), 10.0f));
        titleSize = a.getDimension(R.styleable.CustomCircleProgressBar_progress_text_size, CommonUtils.dp2px(getContext(), 6.0f));
        progressWidth = a.getDimension(R.styleable.CustomCircleProgressBar_progress_width, CommonUtils.dp2px(getContext(), 10.0f));
        progress = a.getFloat(R.styleable.CustomCircleProgressBar_progressv, 50.0f);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(progressText, getMeasuredWidth() / 2 - rect.width() / 2, baseline - progressTextSize / 2, paint);
        ...
        canvas.drawText(title, getMeasuredWidth() / 2 - rect.width() / 2, baseline + progressTextSize / 2, paint);
    }
