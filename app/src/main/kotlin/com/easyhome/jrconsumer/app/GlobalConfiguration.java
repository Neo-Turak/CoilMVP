...
import com.easyhome.jrconsumer.app.converter.ResponseConverterFactory;
import com.easyhome.jrconsumer.app.imageloader.JRGlideImageLoaderStrategy;
...
//    public static String sDomain = Api.APP_BASE_URL;
    ...
    public void applyOptions(Context context, GlobalConfigModule.Builder builder) {
        ...
        builder.baseurl(Api.BASE_URL)
                //强烈建议自己自定义图片加载逻辑,因为默认提供的 JRGlideImageLoaderStrategy 并不能满足复杂的需求
                //请参考 https://github.com/JessYanCoding/MVPArms/wiki#3.4
                .imageLoaderStrategy(new JRGlideImageLoaderStrategy())
...
//                })
                ...
                .retrofitConfiguration((context1, retrofitBuilder) -> {//这里可以自己自定义配置 Retrofit 的参数, 甚至您可以替换框架配置好的 OkHttpClient 对象 (但是不建议这样做, 这样做您将损失框架提供的很多功能)
                    retrofitBuilder.addConverterFactory(ResponseConverterFactory.create());
                })
    ...
    public void injectFragmentLifecycle(Context context, List<FragmentManager.FragmentLifecycleCallbacks> lifecycles) {
        lifecycles.add(new FragmentManager.FragmentLifecycleCallbacks() {
            ...
            public void onFragmentDestroyed(FragmentManager fm, Fragment f) {
              ...
              /*  AppWatcher.INSTANCE.getObjectWatcher().watch(f,"Fragment生命周期");*/
//                ((AppWatcher) Objects.requireNonNull(ArmsUtils
//                        .obtainAppComponentFromContext(f.getActivity())
//                        .extras()
//                        .get(AppWatcher.class.getName())))
//                        .getObjectWatcher()
