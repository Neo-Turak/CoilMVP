...
import com.easyhome.jrconsumer.databinding.LayoutLoadingBinding
...
object PageLoadingUtils {
    ...
    fun showProgressDialog(activity: Activity, canCancel: Boolean = false, msg: String = "", listener: (() -> Unit)?) {
        ...
        if (mDialog == null) {
            ...
            mDialog = Dialog(ctx, R.style.dialog)// 创建自定义样式
