 ...
 */
package com.easyhome.jrconsumer.util.runtimepermissions;
...
public class PermissionsManager {
   ...
   * @param explination  权限解释
   */

  public void checkPermissionOnTheFly(Context context,String[] permissions,String explination){
